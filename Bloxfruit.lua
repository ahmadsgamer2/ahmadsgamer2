...
Main3:Toggle("Auto Farm Level",_G.AutoFarm or AutoFarmQuest,function(value)
     local MyLevel = game.Players.LocalPlayer.Data.Level.Value
     if MyLevel == 2448 or MyLevel <= 2449 then
     _G.AutoFarm = value 
     end 
	_G.Seet = value
	_G.M = value
