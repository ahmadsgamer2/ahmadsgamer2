...
function CheckQuest()
	...
	elseif MyLevel >= 2475 then
        ...
        VectorMon = CFrame.new(-16901.26171875, 84.06756591796875, -192.88906860351562)
    
        CFrameQuest = CFrame.new(-16547.748046875, 61.13533401489258, -173.41360473632812)
        VectorQuest = Vector3.new(-16547.748046875, 61.13533401489258, -173.41360473632812)
	elseif MyLevel >= 2525 or 2550 then
		LevelQuest = 36
        ...
        VectorMon = CFrame.new(-16347.4150390625, 92.09503936767578, 1122.335205078125)
    
        CFrameQuest = CFrame.new(-16539.078125, 55.68632888793945, 1051.5738525390625)
        VectorQuest = Vector3.new(-16539.078125, 55.68632888793945, 1051.5738525390625)
		end
	end
end 
]]
