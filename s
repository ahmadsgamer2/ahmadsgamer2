  ...
  local Win = VLib:Window("Manahub", "legends of speed")
local Autofarm = Win:Tab("Autofarm")
local tp = Win:Tab("teleport")
local pt = Win:Tab("calculator rebirth")
local pets = Win:Tab("auto pets")
local autoRace = Win:Tab("AutoRace")
local trading = Win:Tab("trading")
local Credits = Win:Tab("Credits")


local speedfarm = {"Super sonic", "Fast", "Slow"}

Autofarm:Dropdown("Select Speed Auto Farm", speedfarm, function(mode)
_G.SelectMode = mode
end)

Autofarm:Toggle("Auto Farm city red orbs", false, function(start)
if start == true then
_G.StartFarm = true
...
if _G.SelectMode == 'Super sonic' then
  for i = 1,090 do
     local args = {
         [1] = "collectOrb",
         [2] = "Red Orb",
     ...
     repeat task.wait(0.001) until _G.StartFarm
  elseif _G.SelectMode == 'Fast' then
     for i = 1,30 do
        local args = {
            [1] = "collectOrb",
            [2] = "Red Orb",
        ...
        repeat task.wait(0.001) until _G.StartFarm
     elseif _G.SelectMode == 'Slow' then
        for i = 1,2 do
           local args = {
               [1] = "collectOrb",
               [2] = "Red Orb",
...
Autofarm:Toggle("Auto Farm Magma red orbs ", false, function(start)
   if start == true then
   _G.StartFarm = true
   elseif start == false then
      _G.StartFarm = false
...
Autofarm:Toggle("Auto hoops", false, function(hoop)
  hoops = hoop
  while hoops do task.wait()
...
autoRace:Toggle("Auto Race 1st ", false, function(rac)
race = rac
while race do task.wait()
local args = {
  [1] = "joinRace"
}
game:GetService("ReplicatedStorage").rEvents.raceEvent:FireServer(unpack(args))

  for _,v in pairs(game:GetService("Workspace").raceMaps.Grassland.finishLine:GetChildren(48.311, 36.315, -8680.453)) do
     game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.CFrame
     wait(.6)
 end
 wait(0.1)
 
 for _,v in pairs(game:GetService("Workspace").raceMaps.Desert.finishLine:GetChildren(1686.075, 36.315, -5946.634)) do
     game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.CFrame
     wait(.6)
 end
 wait(0.1)
 ...
 for _,v in pairs(game:GetService("Workspace").raceMaps.Magma.finishLine:GetChildren(1001.331, 36.315, -10986.218)) do
     game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.CFrame
     wait(.1)
 end
 wait(0.6)
...
autoRace:Toggle("Auto Race lag 2nd ",false, function (rac) 
  ...
  function tp()
      local site = game.HttpService:JSONDecode(game:HttpGet('https://games.roblox.com/v1/games/3101667897/servers/Public?sortOrder=Asc&limit=100'))
      game.TeleportService:TeleportToPlaceInstance(3101667897, site.data[math.random(1, table.getn(site.data))].id)
  end
   
  function join()
      game.ReplicatedStorage.rEvents.raceEvent:FireServer('joinRace')
      wait()
      player.PlayerGui:WaitForChild('gameGui').raceJoinLabel.Visible = false
  end
  ...
  local participation = player.PlayerGui:WaitForChild('gameGui').participationRewardLabel
  participation:GetPropertyChangedSignal('TextTransparency'):Connect(function()
      if participation.TextTransparency == 1 then
          tp()
      end
  end)
  if game.ReplicatedStorage.raceTimer.Value >= raceTimer or game.ReplicatedStorage.raceStarted.Value == true then
      tp()
  elseif game.ReplicatedStorage.raceInProgress.Value == true then
      join()
  end
  end)

  autoRace:Toggle("Auto Race 3rd" ,false,function(state)
...
Credits:Button("XxAhmadxX", function()

end)

Credits:Button("blacksgamer", function()

end)

pt:Button("click copy calu rebirth work glicht", function()
   setclipboard("https://raw.githubusercontent.com/ahmadsgamer2/ahmadsgamer2/main/README.md")
end)

Credits:Button("click Copy Discord link", function()
  setclipboard("https://discord.gg/YFYPY4zf")
end)

pt:Toggle("Auto Rebirths",false, function(state)
...
pt:Toggle('Auto Rebirth x1 ',false, function(state)
spawn(function ()
...
pt:Toggle('Auto Rebirth x2 ',false, function(state)
   spawn(function ()
      RunService.RenderStepped:Connect(function ()
         if autoRebirth then
            local args = {[2] = "rebirthRequest"}
             game:GetService("ReplicatedStorage").rEvents.rebirthEvent:FireServer(unpack(args))
          end 
       end)
     end)
...
pets:Toggle('Red Crystal', function ()
        while wait() do
            if w.flags.ReC then
...
pets:Toggle('Purple Crystal', function () 
        while wait() do
            if w.flags.PuC then
...
pets:Toggle('Yellow Crystal', function ()
        while wait() do
            if w.flags.YeC then
...
pets:Toggle('Lightning Crystal', function ()
        while wait() do
            if w.flags.LiC then
...
pets:Toggle('Snow Crystal', function ()
        while wait() do
            if w.flags.SnC then
...
pets:Toggle('Inferno Crystal', function ()
        while wait() do
            if w.flags.InC then
...
pets:Toggle('Electro Legends Crystal', function ()
        while wait() do
            if w.flags.ElC then
...
pets:Toggle('Space Crystal', function ()
        while wait() do
            if w.flags.SpC then
...
pets:Toggle('Alien Crystal', function ()
        while wait() do
            if w.flags.AlC then
...
pets:Toggle('Desert Crystal', function ()
        while wait() do
            if w.flags.DeC then
...
pets:Toggle('Electro Crystal', function ()
        while wait() do
...
tp:Button("Race Desert City", function()
game.Players.LocalPlayer.Character:MoveTo(Vector3.new(58.8, 1.007, -8684.72))
end)

tp:Button("Race Magma City", function()
game.Players.LocalPlayer.Character:MoveTo(Vector3.new(1013.4, 1.007, -10997))
end)

tp:Button("Race Grassland City", function()
        game.Players.LocalPlayer.Character:MoveTo(Vector3.new(1687.65, 1.007, -5943.91))
end)

tp:Button("Race speed Space", function()
        game.Players.LocalPlayer.Character:MoveTo(Vector3.new(-4366.38, 42.98, -14036.68))
end)

tp:Button("Race speed Desert", function()
        game.Players.LocalPlayer.Character:MoveTo(Vector3.new(2053.67, 71.93, 17943.08))
end)


tp:Button("Hiding place City", function()
   game.Players.LocalPlayer.Character:MoveTo(Vector3.new(6663.30, 23.69, 5579.99))
   end)
   
   tp:Button("Hiding place Space", function()
   game.Players.LocalPlayer.Character:MoveTo(Vector3.new(414.33, 44.83, 1057.48))
   end)
   
   tp:Button("Hiding place desert", function()
   game.Players.LocalPlayer.Character:MoveTo(Vector3.new(1945.77, 53.62, 2130.74))
   end)

   trading:Button("trade enbale", function()
      local args = {[1] = "enableTrading"}     
      game:GetService("ReplicatedStorage").rEvents.tradingEvent:FireServer(unpack(args))     
   end)

   trading:Button("trade disable", function()
local args = {[1] = "disableTrading"}
game:GetService("ReplicatedStorage").rEvents.tradingEvent:FireServer(unpack(args))
   end)


   autoRace:Toggle("Auto join race" ,false,function(state)
      _G.Farm = (state and true or false)
      wait()
      while _G.Farm == true do
         wait(0.6)  local args = {[1] = "joinRace"}
game:GetService("ReplicatedStorage").rEvents.raceEvent:FireServer(unpack(args))
   end
end)

Autofarm:Toggle("Auto Farm snow red orbs", false, function(start)
   if start == true then
   _G.StartFarm = true
   elseif start == false then
     _G.StartFarm = false
...
Autofarm:Toggle("Auto Farm snow Orange orbs", false, function(start)
   if start == true then
   _G.StartFarm = true
   elseif start == false then
     _G.StartFarm = false
...
Autofarm:Toggle("Auto Farm city Orange orbs", false, function(start)
   if start == true then
   _G.StartFarm = true
   elseif start == false then
     _G.StartFarm = false
   ...
   Autofarm:Toggle("Auto Farm Magma Orange orbs", false, function(start)
      if start == true then
      _G.StartFarm = true
      elseif start == false then
        _G.StartFarm = false
...
Autofarm:Toggle("Auto Farm city Exp orbs", false, function(start)
   if start == true then
   _G.StartFarm = true
   elseif start == false then
     _G.StartFarm = false
...
Autofarm:Toggle("Auto Farm snow Exp orbs", false, function(start)
   if start == true then
   _G.StartFarm = true
   elseif start == false then
     _G.StartFarm = false
   ...
   Autofarm:Toggle("Auto Farm magma Exp orbs", false, function(start)
      if start == true then
      _G.StartFarm = true
      elseif start == false then
        _G.StartFarm = false
